...
% TODO: Include the following commented part into the corresponding sections below.
% We give here the detailed formulae for \textsc{Derivatives} and \textsc{UpdateParams}.
...
% \begin{align*}
% 	\tilde{\alpha}_m & =  \tilde{\mu}_m / \tilde{\sigma}^2_m, \\
