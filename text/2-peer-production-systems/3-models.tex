...
%An increasing item difficulty $d_i$ monotonically decreases the probability $\Prob{u \succ i}$, whereas an increasing user skill $s_u$ monotonically increases $\Prob{u \succ i}$.
