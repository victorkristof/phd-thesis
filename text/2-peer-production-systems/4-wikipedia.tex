...
\begin{figure*}
	\includegraphics{pps-wikipedia-pr}\hfill\includegraphics{pps-wikipedia-cs}
...
Figure~\ref{pps:fig:wikipr} (left and center) presents the precision-recall curves for all methods.
