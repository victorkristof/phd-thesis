...
% They are then used as features while training the full model as described in Section-\ref{sec:training}, where we use the same training set.
...
% Please refer to Appendix~\ref{sec:hyperparams} for details about hyperparameters.
